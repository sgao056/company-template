      ...
      <Colxx xxs="12" className="portal_items mt-4">
        <Card className="mb-3 portal_item_card">
            ...
            <Row className="mt-3  mb-3">
                ...
                <Colxx xxs="7" className="pl-2 d-flex flex-grow-1 min-width-zero">
                        ...
                        <div>
                            ...
                            <p className="list-item-heading mb-2    ">
                                ...
                                {attr.description.map((text)=>{
                                    return  <li key={text} className="mb-2 text-muted text-small w-sm-100">{text}</li>
                                })}
                        </div>
                        <div className="rtl">
                            <Button className="portal_item_mint" color="primary">
                                Mint
                            </Button>
                        </div>
                    </div>
