...
import "../../../assets/css/sass/views/dashboard.scss";
  ...
  <div className='container'>
    <CommonHeader 
      ...
      <Row className="dashboard_first_row ">
        ...
        {/* images part */}
        <Colxx xxs="12" md="4" className=" d-flex justify-content-center align-items-center mb-xs-5 mb-md-0 ">
          <Row className="dashboard_first_row_portals ">
            <Colxx xxs="6" className='d-flex justify-content-center align-items-center m-0 p-0'>
              <Card className='dashboard_images m-2'>
                <CardImg
                  src="/assets/img/portal/Frame-11.png"
                />
                <CardImgOverlay className='d-flex justify-content-center align-items-center dashboard_images_text_box'>
            ...
            <Colxx xxs="6" className='d-flex justify-content-center align-items-center m-0 p-0'>
              <Card className='dashboard_images m-2'>
                <CardImg
                  src="/assets/img/portal/Frame-12.png"
                />
                <CardImgOverlay className='d-flex justify-content-center align-items-center dashboard_images_text_box'>
                  <CardText className='mb-0'>
                    <b>245</b>/500
            ...
            <Colxx xxs="6" className='d-flex justify-content-center align-items-center m-0 p-0'>
              <Card className='dashboard_images m-2'>
                <CardImg                  
                src="/assets/img/portal/Group-96702.png"
                />
                <CardImgOverlay className='d-flex justify-content-center align-items-center dashboard_images_text_box'>
                  <CardText className='mb-0'>
                    <b>0</b>/100
        ...
        {/* textarea part */}
        <Colxx xxs="12" md="8" className=" d-flex justify-content-center align-items-center ">
